...
w.kbn_setting3='180x170'; /*看板娘大小(px)*/
w.kbn_setting4='right:10'; /*停靠侧:到侧边距离(px)*/
w.kbn_setting5='160x50'; /*提示框大小(px)*/
...
/*－－－－以下勿改－－－－*/
 ...
 if(w[key] || navigator.connection.type != 'wifi'){return;}
 try {
  w[key] = true;
  const lib = document.createElement('script');
  lib.src = 'https://cdn.jsdelivr.net/gh/IlysvlVEizbr/Live2D@1.7/kbn.js';
  lib.defer = true;
